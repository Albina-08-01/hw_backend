...
def start():
    boss = Boss("OverLord", random.randint(900, 1200), 60)
    warrior = Warrior("Soup", random.randint(300, 400), 30)
    medic_1 = Medic("Doc", random.randint(300, 440), 8, 25)
    medic_2 = Medic("Pavel", random.randint(270, 300), 1, 5)
